...
struct b2Jacobian
{
   b2Jacobian(): linearA(), angularA(), linearB(), angularB(0) {}
...
struct b2JointDef
{
   ...
   // the compiler would linke this ...alex
   virtual ~b2JointDef() {}
...
private:
   b2JointDef(const b2JointDef& unimplemented);
   b2JointDef& operator=(const b2JointDef& unimplemented);
};
...
private:
   b2Joint(const b2Joint& unimplemented);
   b2Joint& operator=(const b2Joint& unimplemented);
};
