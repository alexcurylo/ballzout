...
struct b2Mat22
{
   ...
   // should zero members ...alex
	...
	explicit b2Mat22(float32 angle) : col1(), col2()
	{
...
inline bool operator == (const b2Vec2& a, const b2Vec2& b)
{
	//return a.x == b.x && a.y == b.y;
   // avoid float comparison warning ...alex
   return twEqualFloats(a.x, b.x) && twEqualFloats(a.y, b.y);
}
