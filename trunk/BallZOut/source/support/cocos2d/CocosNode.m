...
{
	twlog("add:z:tag: is deprecated. Use addChild:z:tag:");
...
{
	twlog("add:z:tag:parallaxRatio: is deprecated. Use addChild:z:parallaxRatio:");
...
{
	twlog("add:z: is deprecated. Use addChild:z:");
...
{
	twlog("add: is deprecated. Use addChild:");
...
{
	twlog("remove: is deprecated. Use removeChild:cleanup:");
	return [self removeChild:child cleanup:NO];
}
-(void) removeAndStop: (CocosNode*)child
{
	twlog("removeAndStop: is deprecated. Use removeChild:cleanup:");
...
{
	twlog("removeByTag: is deprecated. Use removeChildByTag:cleanup:");
	return [self removeChildByTag:aTag cleanup:NO];
}
-(void) removeAndStopByTag:(int) aTag
{
	twlog("removeAndStopByTag: is deprecated. Use removeChildByTag:cleanup:");
...
-(void) removeChildByTag:(int)aTag cleanup:(BOOL)cleanup
{
	...
	if (child == nil)
		twlog("removeChildByTag: child not found!");
	else
...
-(void) removeAll
{
	twlog("removeAll is deprecated. Use removeAllChildrenWithCleanup:");
	return [self removeAllChildrenWithCleanup:NO];
}
-(void) removeAndStopAll
{
	twlog("removeAndStopAll is deprecated. Use removeAllChildrenCleanup:");
...
{
	twlog("getByTag: is deprecated. Use getChildByTag:");
...
{
	twlog("do: is deprecated. Use runAction: instead");
...
-(Action*) runAction:(Action*) action
{
	...
	if ( [actions containsObject:action] ) {
		...
		twlog("runAction: Action saved from removal");
		return action;
	}
...
-(void) stopAction: (Action*) action
{
	if( [actionsToAdd containsObject:action] )
		...
		if( ![actionsToRemove containsObject:action] )
			...
			twlog("stopAction: Action already scheduled for removal!");
	}
	else
		twlog("stopAction: Action not found!");
}
...
-(void) stopActionByTag:(int) aTag
{
	...
	twlog("stopActionByTag: Action not running or already scheduled for removal!");
}
...
-(Action*) getActionByTag:(int) aTag
{
	...
	for( Action *a in actionsToRemove ) {
		if( a.tag == aTag ) {
			twlog("getActionByTag: Action unavailable, scheduled for removal!");
			return nil; 
		}
	}
	// is running ?
	...
	twlog("getActionByTag: Action not found");
	return nil;
}
...
-(void) schedule: (SEL) selector interval:(ccTime)interval
{
	...
	if( [scheduledSelectors objectForKey: NSStringFromSelector(selector) ] ) {
		twlog("CocosNode.schedule: Selector already scheduled: %@",NSStringFromSelector(selector) );
		return;
	}
...
-(void) unschedule: (SEL) selector
{
	...
	if( ! (timer = [scheduledSelectors objectForKey: NSStringFromSelector(selector)] ) )
	 {
		 twlog("CocosNode.unschedule: Selector not scheduled: %@",NSStringFromSelector(selector) );
		 return;
	 }
