...
struct b2Filter
{
   b2Filter() : categoryBits(0), maskBits(0), groupIndex(0) {}
...
private:
   b2FixtureDef(const b2FixtureDef& unimplemented);
   b2FixtureDef& operator=(const b2FixtureDef& unimplemented);
};
...
private:
   b2Fixture(const b2Fixture& unimplemented);
   b2Fixture& operator=(const b2Fixture& unimplemented);
};
