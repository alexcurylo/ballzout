...
{
   b2ManifoldPoint() : localPoint(), normalImpulse(0), tangentImpulse(0), id() {}
...
struct b2Manifold
{
   ...
   b2Manifold() : localNormal(), localPoint(), type(e_circles), pointCount(0) {}
...
{
   b2RayCastInput() : p1(), p2(), maxFraction(0) {}
...
{
   b2RayCastOutput() : normal(), fraction(0) {}
